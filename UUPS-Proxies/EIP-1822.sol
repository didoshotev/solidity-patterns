...
// removes the need to inherit a Proxy

// it stores the contract logic on specific store, thus slot 0 issue is removed
// let contractLogic := sload(keccak256("PROXIABLE"))
