...
// issue: each contract has to inherit ProxyStorage because Implementation Contract can't start from SLOT 0

contract ProxyStorage {
    address public otherContractAddress; // SLOT 0
...
contract NotLostStorage is ProxyStorage {
    address public myAddress; // SLOT 1
    uint public myUint;       // SLOT 2
